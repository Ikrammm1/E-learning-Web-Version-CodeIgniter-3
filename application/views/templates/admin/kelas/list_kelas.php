    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary"><?php echo $title; ?>
          <a href="<?php echo base_url('C_kelas/tambah_data'); ?>" class="btn btn-primary float-right">Tambah Data</a>
      </div>
      <div class="card-body">
              ...
              ?>
                <tr>
                  ...
                  <td>
                    ...
                    <a href="<?php echo base_url() ?>C_kelas/edit_data/<?php echo $kelas['id_kelas_mapel']; ?>">
                    ...
                    <a href="<?php echo base_url() ?>C_kelas/hapus_data/<?php echo $kelas['id_kelas_mapel']; ?>" class="badge badge-danger">
